...
public class MainEx02Set 
{
	public static void main(String[] args) 
	{
		/**
		 * HashSet
		 * Internamente utiliza tabela de dispersão (hash table), por isso, destaca-se pela eficiencia: Complexidade O(1) para operações de add e delete.
		...
		hashSet.add( new MyClass(1, "ummmmmmm") );	// Não será adicionado pois a chave é o atributo "inteiro" definido em hashCode() em MyClass. 
		...
		/**
		 * TreeSet
		 * Internamente utiliza uma estrutura de árvore.
